...
export default class NewVendorAvailabilityCalendar extends NavigationMixin(LightningElement) {
    @track weekData = [];
    ...
    @wire(getExistingVendorAvailability, { currentId: '$recordId' })
    ...
    convertToOrgTimezone(date) {
        const options = {
            timeZone: 'Europe/London',  // Use the organization timezone
            year: 'numeric',
            month: '2-digit',
            day: '2-digit',
            hour: '2-digit',
    ...
    handleSave() {
        ...
        saveRecords({ dataList: JSON.stringify(vendorAvailability), currentId: this.recordId })
            .then(result => {
            ...
            .catch(() => {
                ...
                this.dispatchEvent(new CloseActionScreenEvent());// Close the quick action screen on error
            });
    }
