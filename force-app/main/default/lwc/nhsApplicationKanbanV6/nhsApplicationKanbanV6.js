...
// 7 top-level stages — Valuations Ready added between Figures to Chase and Figures Returned
const TOP_STAGES = [
...
export default class NhsApplicationKanbanV6 extends NavigationMixin(LightningElement) {
