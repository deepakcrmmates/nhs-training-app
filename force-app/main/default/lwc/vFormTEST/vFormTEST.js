...
export default class VFormTEST extends LightningElement {
    ...
    @api note;
    @api agentId = '001KG00000869ZAYAY'; //this will comes from vf page 
    @api recordsId = '006KG000002ErrkYAC';//this will comes from vf page 
   ...
   handleChange(event) {
    ...
    handleClick(event) {
        ...
        console.log('OUTPUT :fields ', JSON.stringify(fields));
