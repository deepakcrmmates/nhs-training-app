...
export default class OpportunityKanban extends NavigationMixin(LightningElement) {
  @track columns;
  @track recordTypes;
  @api selectedRecordTypeId = 'Part_Exchange_Applications';
   @track circleClass;
